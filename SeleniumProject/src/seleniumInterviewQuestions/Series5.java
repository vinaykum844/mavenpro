...
public class Series5 {
	/**
	 * How to do mouse over How to do drag drop How to do double click How Keys
	 * class works
	 */
	...
	public static void main(String[] args) {
		...
		action1.clickAndHold(driver.findElement(By.xpath(""))).moveToElement(driver.findElement(By.xpath("")))
