...
public class VerifyHighestPriceFilter extends TestBase {
	
private final Logger log=LoggerHelper.getLogger(verifyLowestPriceFilter.class);
	
	@Test
	public void verifyHighestPriceFilterlist_detailsPage() throws InterruptedException
	{
		...
		pcategorypage.selectSortByFilter("Price: Highest first");
